...
BEFORE running this macro, source `setup.sh` or `setup.csh` as appropriate for your shell to set the `DVCS_ep` environment variable. This sets the paths automatically.
