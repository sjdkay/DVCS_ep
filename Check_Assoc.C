...
void Check_Assoc(TString InFile = ""){
  ...
  TFile *ofile = TFile::Open(Form("%s_OutputHists.root", (InFile.Remove(InFile.Length() - 22)).Data()),"RECREATE"); // 22 cuts the .eicrecon.edm4eic.root from the original input file name
